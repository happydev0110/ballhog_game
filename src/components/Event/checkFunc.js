...
export const checkFunc = (sportCategory, dataTypeItem, currentPlayItem, prevPlayItem, team1Id, team2Id, matchTeamId, PREV_NHL_DS2, PREV_NHL_DS5, OffensivePlays_NFL) => {
    ...
    if (dataTypeItem.no === 'NFL-DS2-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.start.team === undefined || currentPlayItem.end.team === undefined) {
            ...
            if (startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.scoringPlay != false || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.statYardage >= 20 || currentPlayItem.statYardage < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS2-2') {
        if (currentPlayItem.text === undefined || currentPlayItem.start.team === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4]
            if (currentPlayItem.text.toLowerCase().includes('no play') || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.scoringPlay != false || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.statYardage >= 10 || currentPlayItem.statYardage < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS3-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4]
            if (currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.scoringPlay != false || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.statYardage <= 19 || currentPlayItem.statYardage < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS3-2') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4];
            if (currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.scoringPlay != false || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.start.yardsToEndzone - currentPlayItem.end.yardsToEndzone <= 9 || currentPlayItem.start.yardsToEndzone - currentPlayItem.end.yardsToEndzone < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS3-2-2') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4];
            if (currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.scoringPlay != false || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.start.yardsToEndzone - currentPlayItem.end.yardsToEndzone < currentPlayItem.start.distance || currentPlayItem.start.yardsToEndzone - currentPlayItem.end.yardsToEndzone <= 9) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS3-2-4') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4];
            if (!currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.scoringPlay != false || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.end.team.id != team1Id || currentPlayItem.end.down != 1 || currentPlayItem.statYardage - currentPlayItem.end.yardsToEndzone >= 10 || currentPlayItem.statYardage - currentPlayItem.end.yardsToEndzone < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS21-2') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            let startDowns = [1, 2, 3, 4];
            if (currentPlayItem.text.toLowerCase().includes('no play') || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.scoringPlay != false || currentPlayItem.end.team.id != team2Id || currentPlayItem.end.down != 1 || currentPlayItem.statYardage < currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NFL-DS40') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            var startDowns = [1, 2, 3, 4]
            var words = ['face mask', 'unnecessary roughness', 'illegal contact', 'illegal use of hands', 'roughing the kicker', 'roughing the passer', 'defensive holding', 'defensive pass interference', 'unsportsmanlike conduct', 'horse collar tackle']
            if (currentPlayItem.text.toLowerCase().includes('enforced between downs') || currentPlayItem.text.toLowerCase().includes('offsetting') || !checkWords(currentPlayItem.text.toLowerCase(), words) || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.statYardage < 0 || currentPlayItem.end.team.id != team2Id) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NCAAFB-DS12-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.scoringType === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            if (dataTypeItem.matchList.indexOf(parseInt(currentPlayItem.type.id)) != -1 || currentPlayItem.type.id != 32 || currentPlayItem.scoringType.name != 'touchdown' || currentPlayItem.scoringPlay != true || currentPlayItem.end.team.id != team2Id) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NCAAFB-DS13-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            ...
            let startDowns = [1, 2, 3, 4]
            if (currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.text.toLowerCase().includes('sacked') || currentPlayItem.text.toLowerCase().includes('kneels') || currentPlayItem.scoringPlay != false || startDowns.indexOf(parseInt(currentPlayItem.start.down)) == -1 || currentPlayItem.end.team.id != team2Id || currentPlayItem.statYardage >= 0) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NCAAFB-DS13-2') {
        if (currentPlayItem.text === undefined) {
            ...
            if (currentPlayItem.text.toLowerCase().includes('no play') || currentPlayItem.text.toLowerCase().includes('sacked') || currentPlayItem.scoringPlay != false || parseInt(currentPlayItem.start.down) != 4 || currentPlayItem.end.team.id != team1Id || currentPlayItem.statYardage >= 0) {
                status = true;
            }
        }
    }
    ...
    if (dataTypeItem.no === 'NCAAFB-DS16-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined || currentPlayItem.pointAfterAttempt === undefined || currentPlayItem.scoringType != undefined) {
            status = true;
        } else {
            let pointAfterAttempts = [1, 2]
            if (currentPlayItem.scoringPlay != true || currentPlayItem.end.team.id != team1Id ||
                currentPlayItem.scoringType.name != 'touchdown' || pointAfterAttempts.indexOf(parseInt(currentPlayItem.pointAfterAttempt.value)) == -1) {
                status = true;
            }
        }
    }
    ...
    // NCAAFB-DS24
    if (dataTypeItem.no === 'NCAAFB-DS24') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            status = true;
        } else {
            if (dataTypeItem.matchList.indexOf(parseInt(currentPlayItem.type.id)) != -1 || currentPlayItem.start.down != 4 || currentPlayItem.end.team.id != team1Id || currentPlayItem.statYardage >= currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
    ...
    // NCAAFB-DS24-1
    if (dataTypeItem.no === 'NCAAFB-DS24-1') {
        if (currentPlayItem.text === undefined || currentPlayItem.end === undefined || currentPlayItem.end.team === undefined) {
            status = true;
        } else {
            if (dataTypeItem.matchList.indexOf(parseInt(currentPlayItem.type.id)) != -1 || currentPlayItem.start.down != 4 || currentPlayItem.end.team.id != team2Id || currentPlayItem.statYardage >= currentPlayItem.start.distance) {
                status = true;
            }
        }
    }
